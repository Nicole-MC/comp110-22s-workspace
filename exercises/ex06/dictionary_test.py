...
def test_favorite_colors() -> None:
    """Test."""
    colors: dict[str, str] = {"george": "blue", "louis": "blue", "alex": "red", "karl": "purple", "clay": "green", "nick": "red", "nicole": "blue"}
...
def test_favorite_colors_tie() -> None:
    ...
    colors: dict[str, str] = {"emma": "green", "nicole": "green", "sarah": "pink", "george": "blue", "clay": "blue"}
    assert favorite_color(colors)
...
def test_counter() -> None:
    """Test for list."""
    values: list[str] = ["berries", "berries", "veggies", "protein", "water", "berries", "water"]
    assert count(values)


def test_counter_small() -> None:
    """Test for small values."""
    values: list[str] = ["a", "b", "a", "c", "d"]
    assert count(values)


def test_counter_large() -> None:
    """Test for large values."""
    values: list[str] = ["z", "a", "y", "b", "x", "c", "q", "z", "z", "z", "z", "z", "a", "q", "q", "x"]
    assert count(values)